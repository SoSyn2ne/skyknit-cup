...
describe('Skyknot course playthrough', () => {
  it('completes all twelve checkpoints in two to four minutes without boost', () => {
    ...
    for (let step = 0; step < 240 / DT; step += 1) {
    ...
    expect(completedAtSeconds ?? 0).toBeGreaterThanOrEqual(120)
